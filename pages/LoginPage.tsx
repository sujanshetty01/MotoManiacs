        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-black text-gray-900 dark:text-white text-center p-4 overflow-hidden transition-colors duration-300">
            ...
            <div className="relative z-10 w-full max-w-md bg-white/70 dark:bg-black/70 backdrop-blur-sm p-8 rounded-xl border border-gray-200 dark:border-gray-800">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 mt-8">
                    {/* Google Sign In Button - Prominent at the top */}
                    <button
                        type="button"
                        onClick={handleGoogleSignIn}
                        disabled={isGoogleLoading || isLoading}
                        className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-700 rounded-xl text-gray-700 dark:text-gray-300 font-bold text-base hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-red-500 dark:hover:border-red-500 hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-md transform hover:scale-[1.02]"
                    >
                        {isGoogleLoading ? (
                            <>
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-3 bg-white dark:bg-black/70 text-gray-500 dark:text-gray-400 font-medium">Or use email</span>
                        </div>
                    </div>
