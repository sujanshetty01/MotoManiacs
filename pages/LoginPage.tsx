...
const LoginPage: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen flex flex-col items-center justify-center bg-black text-white text-center p-4 overflow-hidden">
             <img 
            ...
            />
            <div className="relative z-10 w-full max-w-md bg-black bg-opacity-70 backdrop-blur-sm p-8 rounded-xl border border-gray-800">
                <div className="flex flex-col items-center">
                    <MotoIcon />
                    <h1 className="text-4xl font-extrabold text-white tracking-tighter uppercase mt-4" style={{ textShadow: '0 0 15px rgba(229, 9, 20, 0.8)' }}>
                        MotoManiacs
                    </h1>
                    <p className="mt-2 text-lg text-gray-300">Login to your account</p>
                </div>
